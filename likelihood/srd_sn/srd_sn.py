...
default_data_file = os.path.join(os.path.split(__file__)[0], "lcparam_Y10_DDF_WFD_3.0xFOUNDATION_noScatter.txt")
default_covmat_file = os.path.join(os.path.split(__file__)[0], "sys_Y10_DDF_WFD_FOUNDATION_2.txt")

...
This module is obtained from https://github.com/des-science/DES-SN5YR/
"""
...
default_data_file = os.path.join(os.path.split(__file__)[0], "SRD_SN.csv")
default_covmat_file = os.path.join(
    os.path.split(__file__)[0], "SRD_SN_COV.txt"
)
...
class SRDSNLikelihood(GaussianLikelihood):
    ...
    def build_data(self):
        ...
        print("Loading SRD 10Y SN data from {}".format(filename))
        ...
        print(
            f"Found {len(self.zCMB)} SRD SN bins"
        )
    ...
    def build_covariance(self):
        ...
        print("Loading SRD 10Y SN covariance from {}".format(filename))
